...
## Process
1. `Read prompt rubrics/evaluator-rubric` at `{{AGENT_DIR}}/skills/app-spec-creator/prompts/rubrics/evaluator-rubric.md` — the five check classes, severities, routing, clone-strict escalation, and `traceability.csv` format. Follow it exactly.
