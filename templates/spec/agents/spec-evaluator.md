...
## Process
1. `Read prompt rubrics/evaluator-rubric` at `{{AGENT_DIR}}/skills/app-spec-creator/prompts/rubrics/evaluator-rubric.md` — the four check classes, severities, routing, and `traceability.csv` format. Follow it exactly.
