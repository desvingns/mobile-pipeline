...
## Process
1. Read prompt `rubrics/analytics-taxonomy` at `{{AGENT_DIR}}/skills/app-spec-creator/prompts/rubrics/analytics-taxonomy.md` — naming convention, required props, event types.
