...
# Fidelity Agent — {{PROJECT_NAME}} (Android, clone)
...
## Gap / context
Fidelity divergence on <screen_id> (<name>): built shows "<observed_built>"; reference shows "<expected_reference>". Filed by {{PREFIX}}-fidelity-android.
