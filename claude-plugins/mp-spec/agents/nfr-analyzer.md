...
## Process
1. Read prompt `rubrics/nfr-categories` at `.claude/skills/app-spec-creator/prompts/rubrics/nfr-categories.md` — the required categories and threshold conventions. Follow it.
