...
## Process
1. `Read prompt techniques/grounding.md` at `${CLAUDE_PLUGIN_ROOT}/skills/mp-spec/prompts/techniques/grounding.md` — it defines the fact categories and the hard rule. Follow it.
