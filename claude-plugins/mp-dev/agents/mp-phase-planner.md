...
1. `- [ ] TASK-NN.1 Run `/mp --fit` over every screen in fit/registry.csv.`
...
Its **Done criteria**: `/mp --fit` reports 0 unexplained divergences (only `spec/deviations.md` entries remain) and the overall fit score meets the project's clone-done threshold. This is the user-requested "reference-comparison as the last phase".
