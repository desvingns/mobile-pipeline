...
**Golden-lock after a fidelity pass (clone projects).** Once a screen passes `/mp --fidelity`
...
hybrid fidelity strategy — the multimodal `mp-fidelity-android` finds divergences; Roborazzi
