...
`STATE.md` reflects *current* state. Update it after **every** `/mp` run, even if `DOCUMENTATION.md` and `CLAUDE.md` need no changes.
...
| **Now → Last completed** | One line: iteration label, what shipped, commit hash, date. Example: `Iteration 6 sub-C — mp-architect agent (commit abc1234, 2026-05-19)`. |
